...
public class CzOrder implements Serializable {
  ...
  private double package_money;//包装费
  
  private String user_id; // 用户ID

  private String goods_id;// 普通商品id
...
////////////////////////////////////////////////////////////////////////  
  ...
  private String prepay_id ; //'预处理订单编号(第三方系统订单号)'
  ...
  private String mobile;//转让人手机号

  private String ip;//用户下单IP地址
////////////////////////////////////////////////////////////////////////  
...
public String getOrder_rs_no() {
  ...
  public void setPackage_money(double package_money) {
